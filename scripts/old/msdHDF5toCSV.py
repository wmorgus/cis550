"""
Code below and dependencies slightly modified by Will Morgus (April 15, 2020) University of Pennsylvania; thanks Alexis Greenstreet
...
def main():
    ...
    basedir = "/Users/willmorgus/Downloads/MillionSongSubset/data/" # "." As the default means the current directory
    ext = ".H5" #Set the extension here. H5 is the extension for HDF5 files.
    #################################################
    #FOR LOOP
    files = getListOfFiles(basedir)
    for f in files:
        if ('.h5' in f):
            print(f)
